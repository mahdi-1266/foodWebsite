        ...
        <div class="card">
          <div class="card-body">
            <div class="m-0">
              ...
              <input type="text" class="form-control" name="foodName" placeholder="Enter the name">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="m-0">
              ...
              <input type="number" class="form-control" name="foodPrice" placeholder="Enter the price">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card">
          <div class="card-body">
            <div class="m-0">
              ...
              <textarea class="form-control" name="foodDesc" rows="3"></textarea>
            </div>
          </div>
        </div>
      </div>
