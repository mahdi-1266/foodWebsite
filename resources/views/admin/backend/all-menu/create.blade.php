...
<div class="app-body w-50 mx-auto mt-4 border border-2">
  ...
  <form action="{{ route('store-all-menu') }}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Row starts -->
    <div class="row gx-3">
        ...
        <div class="card">
          <div class="card-body">
            <div class="m-0">
              ...
              <input type="number" class="form-control" value="0" name="price" placeholder="Enter the price">
            </div>
          </div>
        </div>
      </div>
